...
export const PicturesRotator = ({photos}) => {
  ...
  return photos.map((photo, index) => (
      <div key={photo.url} className={clsx('flex flex-col px-1 pb-2  rounded-md mt-3', index % 2 === 0 ? '-rotate-12' : 'rotate-12', `z-${index * 10}`, photo.className || 'bg-white',  photo.disableRotate && 'rotate-0')} >
